  ...
  return (
    <Box id="hero" sx={{ backgroundColor: 'background.paper', position: 'relative', pt: 4, pb: { xs: 8, md: 10 } }}>
      ...
      <Grid container spacing={2} sx={{ mt: -10, mb: { xs: 8, md: 10 } }}>
          ...
          <Box sx={{ lineHeight: 0 }}>
              <Image src="/images/home-hero.png" width={1000} height={750} objectFit='contain' alt="Hero img" />
            </Box>
            {/* Certificate badge */}
            <Box
          sx={{
        ...
        >
            ...
            <Typography
              variant="h4"
              sx={{ fontWeight: 'bold', mb: 2, fontSize: { xs: '1.3rem', md: '1.3rem' } }}
            >
              Earn Verifiable Certificates for Every Course
            </Typography>
            <Typography variant="body1" sx={{ fontWeight: 'regular', mb: 0, fontSize: { xs: '0.9rem', md: '0.9rem' } }}>
